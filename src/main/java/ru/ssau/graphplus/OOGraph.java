              ...
              XFrameActionListener
{
    ...
    private static DiagramModel diagramModel;
     ...
     static XEventListener xEventListener = new XEventListener() {
    ...
    public void initialize(Object[] object) throws com.sun.star.uno.Exception
    {
        if (object.length > 0) {
            ...
            statusIndicator = UnoRuntime.queryInterface(XStatusIndicatorFactory.class, m_xFrame).createStatusIndicator();

            QI.XPropertySet(m_xFrame).setPropertyValue("IndicatorInterception", statusIndicator);
...
//            XEventBroadcaster xEB = (XEventBroadcaster) UnoRuntime.queryInterface(XEventBroadcaster.class, m_xFrame);
...
//            xEB.addEventListener(xEventListener);
