...
import ru.ssau.graphplus.codegen.impl.PortToMethodDefaultCode;
...
@CodeProviderAnnotation(codeProvider = PortToMethodDefaultCode.class)
public class PortToMethodDefault extends AbstractControlMatch {

    @Inject
    public PortToMethodDefault(ShapeHelperWrapper shapeHelperWrapper, LinkTypeRecogniser linkTypeRecogniser) {
