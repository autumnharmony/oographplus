...
public final class StatusBarInterceptor extends ComponentBase
    ...
    private void showMessageBox(String sCommand) {
        try {
            ...
            XMessageBox xMessageBox = this.m_xMsgBoxFactory.createMessageBox(xWindowPeer, MessageBoxType.INFOBOX, 1, "Dispatch Provider Interceptor Demo", sCommand + " has been intercepted");
